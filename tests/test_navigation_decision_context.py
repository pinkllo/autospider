...
async def test_navigation_phase_task_plan_includes_decision_context(
    ...
    monkeypatch.setattr(
        "autospider.contexts.collection.application.use_cases.navigate.clear_overlay",
        fake_clear_overlay,
    )
    monkeypatch.setattr(
        "autospider.contexts.collection.application.use_cases.navigate.inject_and_scan",
        fake_inject_and_scan,
    )
    monkeypatch.setattr(
        "autospider.contexts.collection.application.use_cases.navigate.capture_screenshot_with_marks",
        fake_capture_screenshot_with_marks,
    )
    monkeypatch.setattr(
        "autospider.contexts.collection.application.use_cases.navigate.build_mark_id_to_xpath_map",
        lambda _snapshot: {},
    )
