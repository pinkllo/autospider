        ...
        try:
            ...
            self.context.runtime_state.collection_config = {
                ...
                "pagination_xpath": (
                    str(
                        getattr(
                            getattr(collector, "pagination_handler", None), "pagination_xpath", ""
                        )
                        or ""
                    )
                    or None
                ...
                "jump_widget_xpath": dict(
                    getattr(
                        getattr(collector, "pagination_handler", None), "jump_widget_xpath", None
                    )
                    or {}
                )
                or None,
            ...
            if not self.context.runtime_state.failure_category:
                ...
                self.context.runtime_state.failure_detail = str(
                    classified.get("detail") or str(exc) or ""
                )
