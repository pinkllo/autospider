...
class ActionExecutor:
    ...
    async def _execute_click(
        ...
        xpaths: list[str] = (
            mark_id_to_xpath.get(resolved_mark_id, []) if resolved_mark_id is not None else []
        )
        ...
        script_step = ScriptStep(
            ...
            description=action.thinking
            or f"点击元素 [{resolved_mark_id or action.target_text or 'text'}]",
        )
    ...
    async def _execute_type(
        ...
        script_step = ScriptStep(
            ...
            key=pressed_key,
            description=action.thinking
            or f"在元素 [{resolved_mark_id or action.target_text or 'text'}] 输入文本",
        )
